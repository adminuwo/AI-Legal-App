...
THROUGH ADVOCATE`;
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] dark:bg-[#111111] text-slate-900 dark:text-white font-sans flex flex-col">
      ...
      <header className="sticky top-0 z-30 w-full bg-white/95 dark:bg-[#111111]/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 pl-14 pr-2.5 sm:px-6 py-2 sm:py-3 flex flex-row items-center justify-between gap-2 shadow-xs shrink-0">
