...
const Login = () => {
  ...
  // Check if first-time user needs pre-login onboarding
  React.useEffect(() => {
    if (!localStorage.getItem('ai_legal_onboarding_completed')) {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-[#F9FAFB] p-4 sm:p-6 md:p-8 relative">
      ...
      {/* Centered Login Card */}
      <div className="max-w-md w-full bg-white border border-[#E5E7EB] shadow-xl rounded-2xl p-8 sm:p-10 my-auto">
        {/* Brand Header */}
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#111827] tracking-tight mb-1">Welcome Back</h1>
          <p className="text-sm text-[#6B7280]">Enter credentials to access your secure workspace.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#FFFFFF] border border-[#E5E7EB] hover:bg-[#F9FAFB] rounded-xl font-medium text-[#111827] transition-all shadow-sm disabled:opacity-50 text-sm"
          >
            {googleLoading ? (
              <div className="w-4 h-4 border-2 border-[#E5E7EB] border-t-[#6D5DFC] rounded-full animate-spin" />
            ) : (
              <>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#FFFFFF] border border-[#E5E7EB] hover:bg-[#F9FAFB] rounded-xl font-medium text-[#111827] transition-all shadow-sm text-sm"
          >
