...
/* ════════════════════════════════════════════
   ...
   ════════════════════════════════════════════ */
const features = [
  { id:0, title:'Precedents Search & Citations',      description:'AI-powered deep internet research, going beyond simple results with comprehensive cited analysis.',  icon:Search,   bgFrom:'rgba(0,24,60,1)',   bgTo:'rgba(0,10,30,1)',  accentColor:'#60a5fa', accentGlow:'rgba(59,130,246,0.35)',  Demo:DeepSearchDemo  },
  { id:1, title:'AI-Powered Legal Research', description:"Transform text prompts into stunning visuals instantly with AI LEGAL™'s AI-powered legal research engine.",          icon:ImageIcon, bgFrom:'rgba(30,0,60,1)',  bgTo:'rgba(15,0,35,1)', accentColor:'#a78bfa', accentGlow:'rgba(139,92,246,0.35)', Demo:ImageGenDemo    },
